...
<body>
    ...
    <main class="main">
        ...
        <section class="content">
            <h1 class="title-content">Fotografías</h1>
            <div class="img-container">
                 ...
                 <div class="card" id="cardsss">
                     <img src="cpanel/imagenes/<?php echo $see['imagen'] ?>" class="imagen" id="resize" onclick="enlargeImg(this)">
    ...
    <script>
        ...
        //   }
        const btnMenu = document.querySelector("#cardsss");
        const menu = document.querySelector("#resize");
