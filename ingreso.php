...
<head>
    ...
    <link rel="stylesheet" href="css/n_ingreso.css">
...
<body>
    ...
    <main class="main">
        ...
        <section class="content">
            <h1 class="title-content">Nuevo Ingreso</h1>
            <article class="becas">
                <div class="container-cards">
                    <div class="cards-info">
                        <?php 
                            $n1="SELECT * from ingreso";
                            $r1=mysqli_query($conn,$n1);
                            while($notice=mysqli_fetch_array($r1)){
                        ?>
                            <div class="card-notice">
                                <a href="cpanel/files/<?php echo $notice['filee'] ?>" class="info-link-a" target="_blank">
