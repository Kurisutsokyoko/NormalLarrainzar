...
<head>
    ...
    <link rel="stylesheet" href="css/oferta-educativa.css">
...
<body>
    ...
    <main class="main">
        ...
        <section class="options">
            <h2 class="subtitle-of">OFERTA EDUCATIVA</h2>
            <div class="options-xd">
                <div class="opt"><a href="antecedentes.php" class="opt-link"><img src="img/oferta 2.0/1/I.png" alt="" class="opt-img"></a></div>
                <div class="opt"><a href="fundamentacion.php" class="opt-link"><img src="img/oferta 2.0/1/II.png" alt="" class="opt-img"></a></div>
                <div class="opt"><a href="actualizacion.php" class="opt-link"><img src="img/oferta 2.0/1/III.png" alt="" class="opt-img"></a></div>
                <div class="opt"><a href="plan-estudios.php" class="opt-link"><img src="img/oferta 2.0/1/IV.png" alt="" class="opt-img"></a></div>
                <div class="opt"><a href="plan-estudios-indigena.php" class="opt-link"><img src="img/oferta 2.0/1/V.png" alt="" class="opt-img"></a></div>
                <div class="opt"><a href="estrategias.php" class="opt-link"><img src="img/oferta 2.0/1/VI.png" alt="" class="opt-img"></a></div>
            </div>
        </section>
    </main>
    <footer class="footer">
