...
<body>
    ...
    <main class="main">
        ...
        <section class="master-card">
            ...
            <div class="card">
                <div class="master">
                    <a href="services/math-lab.php" class="master-link">
                       <img src="img/fotos-servicios/laboratorio-de-matematicas/6.jpg" class="master-img">
                       <h6 class="negritas">Laboratorio de Matemáticas</h6>
                    </a>
                </div>
                <div class="master">
                    <a href="services/leng-lab.php" class="master-link">
                       <img src="img/fotos-servicios/lab-leng/6.jpg" class="master-img">
                       <h6 class="negritas">Laboratorio de Lenguas</h6>
                    </a>
                </div>
                <div class="master">
                    <a href="services/civica.php" class="master-link">
                       <img src="img/fotos-servicios/plaza-civica/5.jpg" class="master-img"><!-- Falta -->
                       <h6 class="negritas">Plaza Cívica</h6>
                    </a>
                </div>
                <div class="master">
                    <a href="services/futbol.php" class="master-link">
                       <img src="img/fotos-servicios/futbol/6.jpg" class="master-img">
                       <h6 class="negritas">Cancha de Fútbol Rápido</h6>
                    </a>
                </div>
                <div class="master">
                    <a href="services/baloncesto.php" class="master-link">
                       <img src="img/fotos-servicios/basketball/6.jpg" class="master-img">
                       <h6 class="negritas">Cancha de Baloncesto</h6>
                    </a>
                </div>
                <div class="master">
                    <a href="services/maestros.php" class="master-link">
                       <img src="img/fotos-servicios/master-zone/4.jpg" class="master-img">
                       <h6 class="negritas">Sala de Maestros</h6>
                    </a>
                </div>
                <div class="master">
                    <a href="services/danza.php" class="master-link">
                       <img src="img/fotos-servicios/danza/6.jpg" class="master-img">
                       <h6 class="negritas">Sala de Danza</h6>
                    </a>
                </div>
                <div class="master">
                    <a href="services/biblioteca.php" class="master-link">
                       <img src="img/fotos-servicios/Biblioteca/6.jpg" class="master-img">
                       <h6 class="negritas">Biblioteca</h6>
                    </a>
                </div>
                <div class="master">
                    <a href="services/cafeteria.php" class="master-link">
                       <img src="img/fotos-servicios/cafeteria/6.jpg" class="master-img">
                       <h6 class="negritas">Cafetería</h6>
                    </a>
                </div>
            </div>
        </section>
