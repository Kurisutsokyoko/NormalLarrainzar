    ...
    <main class="main">
       <section class="top">
        ...
        <section class="content">
            <h3 class="title-content">Vídeos</h3>
            <div class="video-container">
                ...
                <div class="card-video">
                    <iframe src="<?php echo $see['link'] ?>" title="YouTube video player" class="video" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
