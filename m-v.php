...
<body>
    ...
    <main class="main">
        ...
        <section class="text-welcome">
           <h1 class="title-welcome">Misión y Visión</h1>
           <div class="all-text">
               ...
               <div class="text-div">
                   <p class="text">
                        ...
                        <span class="director">MISIÓN</span>
                        <br>
                        Somos una institución formadora de Licenciados en Educación Primaria Intercultural Bilingüe que promueve y desarrolla el aprender a conocer, aprender a hacer, aprender a ser y aprender a vivir juntos, para reorientar y mejorar los procesos de enseñanza y aprendizaje desde una práctica docente sustentada en un enfoque por competencias e intercultural, innovador y transformadora que responda a las exigencias sociales, culturales y económicas de un mundo globalizado y cambiante.                        
                        <br><br>
                        <span class="director">VISIÓN</span>
                        <br>
                        Ser una institución de calidad en la formación de Licenciados en Educación Primaria Intercultural Bilingüe; reconocida por su capacidad y competitividad académica, gestión institucional estratégica, su compromiso por la generación y movilidad de conocimientos y su atención a la diversidad cultural, étnica y lingüística en una Educación integral para todos.
                   </p>
               </div>
               <div class="border"></div>
           </div>
