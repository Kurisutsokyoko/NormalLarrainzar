...
<body>
    ...
    <main class="main">
        ...
        <section class="content">
            <?php
                $calendario="SELECT * from calendario";
                $soli = mysqli_query($conn,$calendario);
                $cal = mysqli_fetch_array($soli);
            ?>
           <img src="cpanel/imagenes/<?php echo $cal['imagen'] ?>" alt="" class="calendar">
       </section>
    </main>
    <footer class="footer">
