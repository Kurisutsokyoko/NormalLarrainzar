...
<body>
    ...
    <main class="main">
        ...
        <section class="text-all">
            <h1 class="title-text">Prácticas profesionales</h1>
            <p class="content-text">
                <br><br>
                Las prácticas profesionales ofrecen la oportunidad de organizar comunidades de aprendizaje en las que tiene tanto valor el conocimiento y experiencia del docente de la Escuela Normal, como del maestro titular de las escuelas primarias indígenas y el estudiante normalista, bajo el supuesto de que el saber y el conocimiento sólo se movilizan si se colocan en el plano del diálogo, el debate y el análisis conjunto. De esta manera, las prácticas profesionales permitirán construir estrategias de acompañamiento específico por parte de los docentes formadores y de los maestros de las escuelas primarias. A través de las prácticas profesionales se establecen los vínculos con la comunidad, así como con los diferentes agentes educativos.
                <br><br>
