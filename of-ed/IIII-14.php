...
<body>
    ...
    <main class="main">
        ...
        <section class="text-all">
            <h1 class="title-text">Servicio social</h1>
            <p class="content-text">
                ...
                <br><br>
                Se propone el desarrollo de actividades profesionales de carácter docente en las escuelas primarias indígenas. Una vez concluido el periodo establecido, la autoridad de la escuela primaria emitirá la constancia de cumplimiento del servicio social, la cual será entregada a la Escuela Normal para expedir la carta de liberación.
