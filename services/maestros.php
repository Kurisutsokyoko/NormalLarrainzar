    ...
    <main class="main">
       <section class="top">
        ...
        <section class="content">
            <h1 class="title-service">Sala de Maestros</h1>
            <article class="all-content">
                <div class="muestra">
                    ...
                    <div class="image-bottom">
                        <img src="../img/fotos-servicios/master-zone/1.jpg" alt="" class="left-2">
                        <img src="../img/fotos-servicios/master-zone/2.jpg" alt="" class="left-2">
                        <img src="../img/fotos-servicios/master-zone/3.jpg" alt="" class="left-2">
                    </div>
                </div>
            <div class="image-right">
                <img src="../img/fotos-servicios/master-zone/4.jpg" alt="" class="left">
                <img src="../img/fotos-servicios/master-zone/5.jpg" alt="" class="left">
                <img src="../img/fotos-servicios/master-zone/6.jpg" alt="" class="left">
            </div>
            </article>
        </section>
    </main>
