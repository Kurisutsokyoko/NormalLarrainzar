...
<body>
    ...
    <main class="main">
        ...
        <section class="content">
            <h1 class="title-service">Plaza Cívica</h1>
            <article class="all-content">
                <div class="muestra">
                    ...
                    <div class="image-bottom">
                        <img src="../img/fotos-servicios/plaza-civica/1.jpg" alt="" class="left-2">
                        <img src="../img/fotos-servicios/plaza-civica/2.jpg" alt="" class="left-2">
                        <img src="../img/fotos-servicios/plaza-civica/3.jpg" alt="" class="left-2">
                    </div>
                </div>
            <div class="image-right">
                <img src="../img/fotos-servicios/plaza-civica/4.jpg" alt="" class="left">
                <img src="../img/fotos-servicios/plaza-civica/5.jpg" alt="" class="left">
                <img src="../img/fotos-servicios/plaza-civica/6.jpg" alt="" class="left">
            </div>
            </article>
        </section>
    </main>
