...
<head>
    ...
    <link rel="stylesheet" href="../css/services-2.css">
...
<body>
    ...
    <main class="main">
        ...
        <section class="content">
            <h1 class="title-service">Biblioteca</h1>
            <article class="all-content">
                <div class="muestra">
                    <p class="muestra-content">

                        La Biblioteca de la Escuela Normal de Licenciatura en Educación Primaria “Lic. Manuel Larraínzar” proporciona al estudiante normalista servicios de apoyo para desarrollar funciones complementarias de las lectivas, culturales y de esparcimiento propias del lugar y eficientar el proceso de enseñanza y aprendizaje de los contenidos de los diferentes cursos que conforman el plan de estudios vigente.
                        <br><br>
                        Está al servicio de todos los estudiantes de la escuela Normal con la finalidad de apoyar las diferentes actividades académicas y de investigación que implementa la escuela. Se cuenta con libros, revistas, tesis, diccionarios, enciclopedias, documentales, materiales audiovisuales, etc.
                        <br><br>
                        Contamos con un acervo bibliográfico de más de 8300 libros de diversas áreas de conocimiento; hasta el momento ha cubierto las necesidades de consulta de los alumnos, sin embargo, seguimos adquiriendo más bibliografía actualizada acorde a las necesidades de los diferentes cursos que conforman la Malla Curricular 2012   
                    </p>
                    <div class="image-bottom">
                        <img src="../img/fotos-servicios/Biblioteca/1.jpg" alt="" class="left-2">
                        <img src="../img/fotos-servicios/Biblioteca/2.jpg" alt="" class="left-2">
                        <img src="../img/fotos-servicios/Biblioteca/3.jpg" alt="" class="left-2">
                    </div>
                </div>
                <div class="image-right">
                    <img src="../img/fotos-servicios/Biblioteca/4.jpg" alt="" class="left">
                    <img src="../img/fotos-servicios/Biblioteca/5.jpg" alt="" class="left">
                    <img src="../img/fotos-servicios/Biblioteca/6.jpg" alt="" class="left">
                </div>
            </article>
        </section>
    </main>
