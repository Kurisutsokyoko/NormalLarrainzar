...
<body>
    ...
    <main class="main">
        ...
        <section class="content">
            <h1 class="title-service">Cancha de Baloncesto</h1>
            <article class="all-content">
                <div class="muestra">
                    ...
                    <div class="image-bottom">
                        <img src="../img/fotos-servicios/basketball/1.jpg" alt="" class="left-2">
                        <img src="../img/fotos-servicios/basketball/2.jpg" alt="" class="left-2">
                        <img src="../img/fotos-servicios/basketball/3.jpg" alt="" class="left-2">
                    </div>
                </div>
            <div class="image-right">
                <img src="../img/fotos-servicios/basketball/4.jpg" alt="" class="left">
                <img src="../img/fotos-servicios/basketball/5.jpg" alt="" class="left">
                <img src="../img/fotos-servicios/basketball/6.jpg" alt="" class="left">
            </div>
            </article>
        </section>
    </main>
