...
<body>
    ...
    <main class="main">
        ...
        <section class="content">
            <h1 class="title-service">Laboratorio de Matematicas</h1>
            <article class="all-content">
                <div class="muestra">
                    ...
                    <div class="image-bottom">
                        <img src="../img/fotos-servicios/laboratorio-de-matematicas/1.jpg" alt="" class="left-2">
                        <img src="../img/fotos-servicios/laboratorio-de-matematicas/2.jpg" alt="" class="left-2">
                        <img src="../img/fotos-servicios/laboratorio-de-matematicas/3.jpg" alt="" class="left-2">
                    </div>
                </div>
                <div class="image-right">
                    <img src="../img/fotos-servicios/laboratorio-de-matematicas/4.jpg" alt="" class="left">
                    <img src="../img/fotos-servicios/laboratorio-de-matematicas/5.jpg" alt="" class="left">
                    <img src="../img/fotos-servicios/laboratorio-de-matematicas/6.jpg" alt="" class="left">
                </div>
            </article>
        </section>
    </main>
