<?php 
    ...
    //Obtencion de ID
    $id = $_GET['id'];
    //Obtencion de info con el ID desde base de datos
    $data = "SELECT * FROM informacion WHERE id='$id'";
    $resultado=mysqli_query($conn,$data);
    $res=mysqli_fetch_array($resultado);
    //Obtencion de la convocatoria desde la base de datos
...
<body>
    ...
    <main class="main">
        ...
        <section class="container">
            <img src="cpanel/imagenes/<?php echo $res['imagen'] ?>" alt="" class="img-title">
            <div class="top-container">
                <h1 class="title-container"><?php echo $res['titulo'] ?></h1>
                <p class="date"><?php echo $res['fecha'] ?></p>
            </div>
            <div class="bodyy">
                <p class="cuerpo"><?php echo $res['cuerpo'] ?></p>
                <!--    <a href="cpanel/download_files.php?file=<?php //echo $res['filee']?>"><?php //echo $res['filee'] ?></a><br>   Esto es para descargar el archivo 
                <a href="cpanel/files/<?php //echo $res['filee'] ?>" class="open" target="_blank"><?php //echo $res['filee']?></a>    -->
            </div>
        </section>
    </main>
    <footer class="footer">
