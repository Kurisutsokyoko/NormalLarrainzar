...
<head>
    ...
    <link rel="stylesheet" href="css/areas-sustantivas.css">
...
<header class="header">
    ...
    <main class="main">
        ...
        <section class="areas-options">
            <h1 class="title-area">Áreas Sustantivas</h1>
            <div class="group">
                <div class="option"><a href="" class="options">Investigación</a></div>
                <div class="option"><a href="" class="options">Docencia</a></div>
                <div class="option"><a href="" class="options">Psicopedagogia</a></div>
                <div class="option"><a href="" class="options">Difusión cultural y extensión educativa</a></div>
            </div>
        </section>
    </main>
    <footer class="footer">
