<?php 
  ...
  $id = $_GET['id'];
  $data = "SELECT * FROM becas WHERE id='$id'";
...
<body>
    ...
    <main class="main">
        ...
        <section class="contenido">
            ...
            <div class="container">
                <h2 class="title-container">Cambios en Beca</h2>
                ...
                <form action="sub-edit.php" method="post" class="formulario" enctype="multipart/form-data">
                    <div class="content-form">
                        <div class="form-group">
                            <label class="label"  for="my-input">Titulo actual</label><br><br>
                            <input id="nombre" class="name-lastname" type="text" name="titulo" value="<?php echo $result['title']; ?>">
                        </div><br><br>
                        <div class="form-group">
                            <label class="label"  for="my-input">Imagen de Portada Actual</label><br><br>
                            <input id="my-input" class="imagen-xd" type="file" name="imagen">
                            <!-- <img src="imagenes/<?php echo $res['imagen']; ?>" alt=""> -->
                        </div><div class="form-group">
                            <label for="my-input" class="label">Arhivo PDF</label><br><br>
                            <input type="file" name="pdf" class="file">
                        </div>
                        <input type="hidden" id="id" name="id" value="<?php echo $res['id'] ?>">
                        <input type="submit" value="Guardar" class="boton" name="Guardar-Beca">
                    </div>
                    <div class="content-form">
                        <label for="my-input" class="label">Imagen actual</label>
                        <img src="../cpanel/imagenes/<?php echo $result['imagen'] ?>" alt="" class="photo-beca">
                        <label for="my-input" class="label">Archivo PDF actual</label>
                        <iframe src="../cpanel/files/<?php echo $result['files'] ?>" frameborder="0"></iframe>
                    </div>
                </form>
            </div>
        </section>
