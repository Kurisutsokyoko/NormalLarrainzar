...
<head>
    ...
    <link rel="stylesheet" href="../css/upload-personal.css">
                ...
                <form action="sub-data.php" method="post" class="formulario" enctype="multipart/form-data">
                    <div class="content-form">
                        <div class="form-group">
                            ...
                            <textarea id="" class="last" type="text" name="nombre"></textarea>
                        </div><br><br>
                        <div class="form-group-2">
                            <label class="label"  for="my-input">Fotografia</label><br><br>
                            <input id="my-input" class="imagen-xd" type="file" name="imagen">
                        </div>
                    ...
                    <div class="content-form"><!--
                        <div class="content-form">
                            ...
                            <br>
                            <br>
                            <textarea name="academic_level" class="last" ></textarea>
                        </div>-->
                        ...
                        <div class="ckeditor" id="ckeditorr" style="visibility:hidden;">
                            <label for="my-input" class="label">Formación Academica</label>
                            <br>
                            <br>
                            <textarea name="academic_formation" id="" class="last2" cols="30" rows="10"></textarea>
                        </div>
                    </div>
                </form>
            </div>
