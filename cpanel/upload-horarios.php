...
<head>
    ...
    <link rel="stylesheet" href="../css/upload-horarios.css">
...
<body>
    ...
    <main class="main">
        ...
        <section class="contenido">
            ...
            <div class="container">
                <h2 class="title-container">Horarios</h2>
                <!--
                    ...
                    <div class="content-form">
                        <div class="data">
                            <div class="form-group">
                                <label class="label"  for="my-input">Semestre</label><br><br>
                                <input id="nombre" class="name-lastname" type="text" name="semestre" placeholder="Ejemplo: 1">
                            </div>
                            <div class="form-group">
                                <label class="label"  for="my-input">Grupo</label><br><br>
                                <input id="nombre" class="name-lastname" type="text" name="group" placeholder="Ejemplo: A">
                            </div>
                        </div>
                        <div class="form-group">
                        ...
                        <input type="submit" value="Guardar" class="boton" name="Guardar-Horario">
                    </div>
                </form>
            </div>
            <div class="container">
                ...
                <?php
                    $query="SELECT * FROM horarios ORDER BY semestre ASC";
                    $result=mysqli_query($conn,$query);
                    while($see=mysqli_fetch_array($result)){
                ?>
                    <div class="all-data">
                        <p class="horario-info"><?php echo $see['semestre']; echo " - "; echo $see['grupo']?></p>
                        <div class="buttons-options">
                            <a href="delete-horarios.php?id=<?php echo $see['id']; ?>" class="but-op" name="delete">delete</a>
                        </div>
                    </div>
                <?php
                    }
