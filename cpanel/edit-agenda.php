<?php 
  ...
  $id = $_GET['id'];
  $data = "SELECT * FROM agenda WHERE id='$id'";
...
<head>
    ...
    <link rel="stylesheet" href="../css/edit-agenda.css">
...
<body>
    ...
    <main class="main">
        ...
        <section class="contenido">
            ...
            <div class="container">
                <h1 class="title-container">Agenda</h1>
                ...
                <form action="sub-edit.php" method="post" class="formulario" enctype="multipart/form-data">
                    <div class="content-form">
                        <div class="form-group">
                            ...
                            <input type="submit" value="Guardar" class="boton" name="Guardar-Agenda">
                        </div><br><br>
                        <div class="form-group">
                            ...
                            <label class="label"  for="my-input">Portada Actual</label><br><br>
