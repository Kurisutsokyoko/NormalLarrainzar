        ...
        <section class="contenido">
            ...
            <div class="container">
                ...
                <section class="content">
                    <h3 class="title-content">Todas las Noticias</h3>
                    <div class="video-container">
                        ...
                        <div class="master">
                            <a class="master-link">
                                ...
                                <div class="buttons">
                                    <a href="edit-notice.php?id=<?php echo $see['id']; ?>" class="button">edit</a>
                                    <a href="delete-notice.php?id=<?php echo $see['id']; ?>" class="button" name="delete">delete</a>
                                </div>
                            </a>
                        </div>
                        <?php
