                ...
                <form action="sub-data.php" method="post" class="formulario" enctype="multipart/form-data">
                    <div class="content-form">
                        <div class="form-group">
                            <label class="label" for="my-input">Nuevo Puesto</label><br><br>
                            <input id="nombre" class="name-lastname" type="text" name="stand" placeholder="   Directivo/Administrativo/Docente"><br><br>
                            <label for="my-input" class="label">Prioridad</label><br><br>
                            <input type="text" class="name-lastname" placeholder="  1/2/3/4/5/6..." name="levels">
                        </div><br><br>
                        <input type="submit" value="Guardar" class="boton" name="Guardar-Stand">
                    </div>
                    <div class="content-form-stand">
                        <div class="content-form">
                            <label for="my-input" class="labels">Lista de Puestos</label>
                            <?php
                            ...
                            <div class="stand">
                                <a class="stand-link">
                                    <div class="stand-info">
                                        <p class="stands"><?php echo $see['levels'];?> - <?php echo $see['stand'] ?></p>
                                        <a href="delete-stand.php?id=<?php echo $see['id'];?>" class="stand-button" name="delete">delete</a>
                                    </div>
                                </a>
                            </div>
                            <?php
