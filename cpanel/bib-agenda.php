...
<head>
    ...
    <link rel="stylesheet" href="../css/bib-agenda.css">
        ...
        <section class="contenido">
            ...
            <section class="container">
                ...
                <div class="menu-content">
                    <a href="upload-agenda.php" class="menu-content-a">Nuevo Elemento</a>
                    <a href="bib-agenda.php" class="menu-content-a">Biblioteca</a>
                </div>
                <div class="content">
                    <h3 class="title-content">Todos los Eventos</h3>
                    <div class="img-container">
                        ...
                        <div class="card-img">
                            <div class="div-img">
                                <img src="imagenes/<?php echo $see['imagen']; ?>" alt="" class="imagen">
                            </div>
                            <h3 class="title-video"><?php echo $see['titulo'] ?></h3>
                            <p class="text-content"><?php echo $see['fecha'] ?></p>
                            <div class="button-opt">
                                <a href="edit-agenda.php?id=<?php echo $see['id']; ?>" class="button-op">edit</a>
                                <a href="delete-agenda.php?id=<?php echo $see['id']; ?>" class="button-op" name="delete">delete</a>
                            </div>
                        </div>
                        <?php
                            }
