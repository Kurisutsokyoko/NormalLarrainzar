<?php 
  ...
  $id = $_GET['id'];
  $data = "SELECT * FROM photos WHERE id='$id'";
...
<head>
    ...
    <link rel="stylesheet" href="../css/edit-photos.css">
...
<body>
    ...
    <main class="main">
        ...
        <section class="contenido">
            ...
            <div class="container">
                <h1 class="title-container">Actualizar Imagen</h1>
                <div class="menu-content">
                    <a href="upload-photos.php" class="menu-content-a">Nuevo Elemento</a>
                    <a href="bib-photos.php" class="menu-content-a">Biblioteca</a>
                </div>
                <form action="sub-edit.php" method="post" class="formulario" enctype="multipart/form-data">
                    <div class="content-form">
                        <div class="form-group">
                            <label class="label"  for="my-input">Nueva Fotografia</label><br><br>
                            <input id="my-input" class="imagen" type="file" name="imagen">
                        </div>
                        <input type="hidden" id="id" name="id" value="<?php echo $res['id']; ?>">
                        <input type="submit" value="Guardar" class="boton" name="Guardar-Imagen">
                    </div>
                    <div class="vieja-imagen">
                        <label class="label2">Anterior Imagen</label>
                        <img src="imagenes/<?php echo $res['imagen'] ?>" alt="" class="imagen-vieja">
                    </div>
                </form>
            </div>
        </section>
