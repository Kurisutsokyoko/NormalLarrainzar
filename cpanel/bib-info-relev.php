...
<head>
    ...
    <link rel="stylesheet" href="../css/bib-notice.css">
        ...
        <section class="contenido">
            ...
            <div class="container">
                ...
                <section class="content">
                    <h3 class="title-content">Toda la Informacion</h3>
                        ...
                        <div class="master">
                            <a class="master-link">
                                ...
                                <div class="master-info">
                                    <p class="cuerpo"><span class="negritas"> <?php echo $see['titulo'] ?></span><br></p>
                                    <span class="cuerpoo"> <?php echo $see['cuerpo'] ?> </span>
                                </div>
                                <div class="buttons">
                                    <a href="edit-info-relev.php?id=<?php echo $see['id']; ?>" class="button">edit</a>
                                    <a href="delete-info-relev.php?id=<?php echo $see['id']; ?>" class="button" name="delete">delete</a>
                                </div>
                            </a>
                        </div>
                        <?php
