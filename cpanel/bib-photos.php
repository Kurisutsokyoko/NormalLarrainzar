...
<head>
    ...
    <link rel="stylesheet" href="../css/bib-photos.css">
    ...
    <main class="main">
        ...
        <section class="contenido">
            ...
            <section class="content">
                <div class="container">
                    <h1 class="title-container">Biblioteca de Imagenes</h1>
                    ...
                    <div class="img-container">
                        ...
                        ?>
                        <div class="card">
                            <img src="imagenes/<?php echo $see['imagen'] ?>" class="imagen">
                            <!--<h5 class="title-img"><?php echo $see['nombre'] ?></h5>
                            <p class="text-img" class="textarea"><?php echo $see['texto'] ?></p>-->
                            <div class="buttons-options">
                                <a href="edit-photo.php?id=<?php echo $see['id']; ?>" class="but-op">edit</a>
                                <a href="delete-photos.php?id=<?php echo $see['id'];//unlink("../cpanel/imagenes/".$see['imagen']); ?>" class="but-op" name="delete">delete</a>
                            </div>
                        </div>
                        <?php
                            }
