...
<head>
    ...
    <link rel="stylesheet" href="../css/bib-videos.css">
    ...
    <main class="main">
        ...
        <section class="contenido">
            ...
            <section class="content">
                <div class="container">
                    <h1 class="title-container">Biblioteca de Videos</h1>
                    ...
                    <div class="video-container">
                        <?php
                            $v1="SELECT * from videos";
                            $res=mysqli_query($conn,$v1);
                            while($video=mysqli_fetch_array($res)){
                        ?>
                        <div class="card-video">
                            <h3 class="title-video"><?php echo $video['titulo']; ?></h3>
                            <iframe src="<?php echo $video['link']; ?>" title="YouTube video player" class="video" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
                            <a href="edit-video.php?id=<?php echo $video['id']; ?>" class="but-op">edit</a>
                            <a href="delete-video.php?id=<?php echo $video['id']; ?>" class="but-op" name="Delete-Video">delete</a>
                        </div>
                        <?php
                            }
                        ?>
