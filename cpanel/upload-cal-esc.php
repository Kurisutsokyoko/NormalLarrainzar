...
<head>
    ...
    <link rel="stylesheet" href="../css/upload-calendar.css">
    ...
    <main class="main">
        ...
        <section class="contenido">
            <div class="menu">
                <div class="data-user">
                    <?php 
                        $user = "SELECT * FROM personal WHERE cargo = 'Directivo' LIMIT 1";
            ...
            <div class="container">
                <h1 class="title-container">Calendario Escolar</h1>
                <!--
                <div class="menu-content">
                    <a href="upload-cal-esc.php" class="menu-content-a">Nuevo Elemento</a>
                </div>
                -->
                    ...
                    <form action="sub-data.php" method="post" class="formulario" enctype="multipart/form-data">
                        <div class="content-form">
                            <div class="form-group">
                                <label class="label"  for="my-input">Imagen de Calendario</label><br><br>
                                <input id="my-input" class="imagen" type="file" name="imagen">
                            </div>
                            <input type="submit" value="Guardar" class="boton" name="Guardar-Calendario">
                        </div>
                    </form>
                </div>
            </div>
            <div class="container-conv">
                ...
                ?>
                    <h2 class="title-container">Anterior</h2>
                    <img src="../cpanel/imagenes/<?php echo $see['imagen'] ?>" class="calendario" alt="">
                <?php
                    }
                ?>
            </div>
