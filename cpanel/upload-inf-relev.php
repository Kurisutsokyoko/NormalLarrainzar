                ...
                <form action="sub-data.php" method="post" class="formulario" enctype="multipart/form-data">
                    <div class="content-form">
                        ...
                        <div class="form-group">
                            ...
                            <input id="my-input" class="imagen-xd" type="file" name="imagen" value="Elegir imagen...">
                        </div>
                        <div class="form-group">
                            <label class="label"  for="my-input">Fecha</label><br><br>
                            <input id="nombre" class="name-lastname" type="date" name="fecha">
                        </div>
                    ...
                    <div class="ckeditor">
                        ...
                        <textarea name="cuerpo" id="ckeitor" class="ckeditor" cols="5" rows="5" ></textarea><!-- cambiar entre file-picker o ckeditor en el id -->
                    </div>
    <script>/*
