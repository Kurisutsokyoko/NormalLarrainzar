<?php 
  ...
  $id = $_GET['id'];
  $data = "SELECT * FROM ingreso WHERE id='$id'";
...
<body>
    ...
    <main class="main">
        ...
        <section class="contenido">
            ...
            <div class="container">
                <h2 class="title-container">Convocatoria</h2>
                <!--
                ...
                <form action="sub-edit.php" method="post" class="formulario" enctype="multipart/form-data">
                    <div class="content-form">
                        <div class="form-group">
                            ...
                            <input type="text" name="document_name" id="" class="document_name" value="<?php echo $res['title'] ?>"><br><br>
                            <label class="label"  for="my-input">Imagen</label><br><br>
                            <input id="my-input" class="imagen" type="file" name="imagen"><br><br>
                            <img src="imagenes/<?php echo $res['imagen']; ?>" alt="" class="imagen_anterior">
                        </div>
            ...
            <div class="container-conv">
                <h2 class="title-container">Archivo PDF</h2>
                <iframe src="files/<?php echo $res['filee'] ?>" frameborder="0" height="700rem" width="440rem" class="iframee"></iframe>
                <!--
                <?php
