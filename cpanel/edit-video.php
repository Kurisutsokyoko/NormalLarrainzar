<?php 
  ...
  $id = $_GET['id'];
  $data = "SELECT * FROM videos WHERE id='$id'";
...
<body>
    ...
    <main class="main">
        ...
        <section class="contenido">
            ...
            <div class="container">
                <h1 class="title-container">Subir Video</h1>
                <div class="menu-content">
                    <a href="upload-videos.php" class="menu-content-a">Nuevo Elemento</a>
                    <a href="bib-videos.php" class="menu-content-a">Biblioteca</a>
                </div>
                <div class="content-edit-video">
                    <form action="sub-data.php" method="post" class="formulario" enctype="multipart/form-data">
                        <div class="form-group">
                            <label class="label"  for="my-input">Titulo del Video</label><br>
                            <input id="my-input" class="text-upload" type="text" name="titulo">
                        </div><br><br>
                        <div class="form-group">
                            <label class="label"  for="my-input">Link del Video</label><br>
                            <input id="my-input" class="text-upload" type="text" name="link">
                        </div>
                        <input type="submit" value="Guardar" class="boton" name="Guardar-Video">
                    </form>
                    <div class="video-anterior">
                        <h3 class="label"><?php echo $res['titulo']; ?></h3>
                        <iframe src="<?php echo $res['link']; ?>" title="YouTube video player" class="video" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
                    </div>
                </div>
            </div>
        </section>
