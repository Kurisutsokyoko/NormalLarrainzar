<?php 
  ...
  $id = $_GET['id'];
  $data = "SELECT * FROM informacion WHERE id='$id'";
...
<body>
    ...
    <main class="main">
        ...
        <section class="contenido">
            ...
            <div class="container">
                <h1 class="title-container">Informacion Relevante</h1>
                <div class="menu-content">
                    <a href="upload-inf-relev.php" class="menu-content-a">Nuevo Elemento</a>
                    <a href="bib-info-relev.php" class="menu-content-a">Biblioteca</a>
                </div>
                <form action="sub-edit.php" method="post" class="formulario" enctype="multipart/form-data">
                    <div class="content-form">
                        <div class="form-group">
                            ...
                            <input id="nombre" class="name-lastname" type="text" name="titulo" value="<?php echo $res['titulo']; ?>">
                        </div><br><br>
                        <div class="form-group">
                            <label class="label"  for="my-input">Imagen de Portada</label><br><br>
                            <input class="imagen" type="file" name="imagen" value="">
                        ...
                        <div class="form-group">
                            ...
                            <input id="nombre" class="name-lastname" type="date" name="fecha" value="<?php echo $res['fecha']?>">
                        </div>
                        <input type="hidden" id="id" name="id" value="<?php echo $res['id']; ?>">
                        <input type="submit" value="Guardar" class="boton" name="Guardar-Info-Relev">
                    </div>
                    <div class="ckeditor">
                        <label class="label"  for="my-input">Cuerpo</label><br><br>
                        <textarea name="cuerpo" id="ckeditor" class="ckeditor" cols="5" rows="5"><?php echo $res['cuerpo']; ?></textarea>
                    </div>
                </form>
            </div>
        </section>
