...
<head>
    ...
    <link rel="stylesheet" href="../css/upload-becas.css">
...
<body>
    ...
    <main class="main">
        ...
        <section class="contenido">
            ...
            <div class="container">
                <h2 class="title-container">Becas</h2>
                <!--
            ...
            <div class="container-becas">
                <h2 class="title-container">Becas Actuales</h2>
                <?php
                ...
                ?>
                    <div class="all-data">
                        ...
                        <img src="../cpanel/imagenes/<?php echo $see['imagen'] ?>" alt="" class="photo-beca">
                        <div class="buttons-options">
                            <a href="edit-beca.php?id=<?php echo $see['id']; ?>" class="but-op">edit</a>
                            <a href="delete-beca.php?id=<?php echo $see['id']; ?>" class="but-op" name="delete">delete</a>
                        </div>
                    </div>
                <?php
                    }
