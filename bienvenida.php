...
<body>
    ...
    <main class="main">
        ...
        <section class="text-welcome">
           <h1 class="title-welcome">Bienvenida</h1>
           <div class="all-text">
               <div class="border"></div>
               <div class="text-div">
                   <p class="text">
                        Bienvenidos al portal de la Escuela Normal de Licenciatura en Educación Primaria “Lic. Manuel Larraínzar”. Somos una escuela de nivel superior formadora de docentes desde febrero de 1960 y actualmente ofertamos la Licenciatura en Educación Primaria Intercultural Bilingüe (LEPIB) y gracias al empeño, dedicación, compromiso y profesionalismo de maestros y maestras que han impartido sus saberes, la escuela Normal goza de un reconocimiento social e institucional.
                        <br><br>
                        Actualmente, la institución está inscrita en los Comités Interinstitucionales para la Evaluación de la Educación Superior A.C. (CIEES) y después de la visita del Comité de Artes, Educación y Humanidades, actualmente estamos ubicados en el nivel 2, por lo que seguimos trabajando en las observaciones de cada una de las diez categorías para el fortalecimiento de la calidad educativa del programa educativo vigente y hacer de nuestra escuela Normal una de las mejores.
                        <br><br>
                        Es importante mencionar que el colegiado directivo le apuesta a una gestión institucional estratégica para solucionar las necesidades reales de la escuela Normal desde un equipo de profesionales que comparten la misión y la visión de la institución.
                        <br><br>
                        Este sitio web se diseñó para que Usted encuentre información específica sobre nuestra historia, oferta educativa, normatividad, estudiantes, docentes, proyectos académicos y diferentes actividades que realizamos. Nuestra escuela está abierta a todos los jóvenes deseosos de ingresar y formarse como profesionales de la educación primaria.
                        <br><br>
                        <span class="director">Mtra. Onelia Hernández Torres</span><br>
                        <span class="director">Directora del plantel</span>
                   </p>
               </div>
               <div class="border"></div>
           </div>
