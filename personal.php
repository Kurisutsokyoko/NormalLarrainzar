<?php 
    ...
    $query="SELECT * from personal ORDER BY orden";
    $resultado=mysqli_query($conn,$query);
    $resu=mysqli_fetch_array($resultado)
?>
<!DOCTYPE html>
<html lang="en">
<head>
    ...
    <main class="main">
        ...
        <section class="master-card">
            <div class="master-all">
                <?php 
                    $query1="SELECT * FROM stand ORDER BY levels"; 
                    $resultado1=mysqli_query($conn,$query1);
                    while($see1=mysqli_fetch_array($resultado1)){
                ?>
                ...
                <div class="card">
                    ...
                    ?>
                            <div class="master">
                                <a href="admin.php" class="master-link">
                                    <img src="cpanel/imagenes/<?php echo $see['imagen'] ?>" class="master-img">
                                    <div class="master-info">
                                        <p class="masters"><span class="blacks">Nombre del <?php echo $see['cargo']?>:</span><br> <?php echo $see['nombre'] ?> </p>
                                        <?php if($see['cargo']!="Personal de Apoyo"){ ?>
                                            <!--<p class="masters"><span class="blacks">Grado Académicos: </span><br> <?php echo $see['academic_levels'] ?> </p>-->
                                            <p class="masters"><span class="blacks">Formación Academica:</span><br><?php echo $see['academic_formation'] ?></p>
                                        <?php }else{ ?>
                                        <?php } ?>
                                    </div>
                                </a>
