...
<body>
    ...
    <main class="main">
        ...
        <section class="form">
            ...
            <form action="cpanel/cpanel.php" method="POST" enctype="multipart/form-data" class="iniciar-sesion">
                <div class="div">
                    <label for="my-input" class="text-div">Usuario:</label>
                    <input type="text" class="text-input" placeholder="Nombre de Usuario" name="usuario">
                </div>
                <div class="div">
                <label for="my-input" class="text-div">Contraseña:</label>
                    <input type="password" class="text-input" placeholder="Contraseña" name="pass">
                </div>
                <input type="submit" value="Iniciar Sesion" class="iniciar" name="iniciar">
            </form>
        </section>
    </main>
    <footer class="footer">
